...
//  },
    ...
    // }
     ...
     const buyCartListhandler= async (cartId)=> {
        const res = await axios.put(`${URI}/items/cart/${cartId}`, config)
        return alert("구매완료")
    }
        ...
        <div>
            ...
            <CartBackground>
                ...
                <div className="cartList">
                    ...
                    <button className="emptybuybutton" onClick={()=>navigate("/")}>구매하러 가기</button>
                    ...
                    <ButtonSet>
                    <button 
                    // onClick={()=>saveCarthandler(cartId)}
                    >더담으러 가기</button>
                    <button
                    onClick={()=>buyCartListhandler(cartId)}
                    >결제하기</button>
                    </ButtonSet>
                    </>}
